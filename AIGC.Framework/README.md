...
2. `AIGC.Framework/workflows/INDEX.md`
3. 命中工作流的 `WORKFLOW.md`
4. 命中工作流的 `rules/INDEX.md`
5. `AIGC.Framework/wiki/INDEX.md`
6. 按 `read_when` 命中的规则继续读取
7. 需要目标项目事实时，读取 `AIGC.Framework/projects/INDEX.md` 和目标项目 wiki 入口
...
如果只是阅读规则，从 `AIGC.Framework/INDEX.md` 开始。
...
如果要执行框架自检，进入 `AIGC.Framework/` 后使用最小 CLI：

...
class OneHarnessCliTests(unittest.TestCase):
    ...
    def test_game_iteration_workflow_is_routable(self) -> None:
        ...
        ui_spec = (ROOT / "AIGC/workflows/game-iteration/rules/ui-ux-development-spec.md").read_text(encoding="utf-8")
        ui_template = (ROOT / "AIGC/workflows/game-iteration/templates/ui-ux-development-spec.md").read_text(encoding="utf-8")
    ...
    def test_game_development_lifecycle_workflow_is_hardened(self) -> None:
        workflow_index = (ROOT / "AIGC/workflows/INDEX.md").read_text(encoding="utf-8")
        capability_index = (ROOT / "AIGC/capabilities/INDEX.md").read_text(encoding="utf-8")
        workflow = (ROOT / "AIGC/workflows/game-development-lifecycle/WORKFLOW.md").read_text(encoding="utf-8")
        stage_gates = (ROOT / "AIGC/workflows/game-development-lifecycle/rules/stage-gates.md").read_text(encoding="utf-8")
        ui_rules = (ROOT / "AIGC/workflows/game-development-lifecycle/rules/ui-visual-runtime.md").read_text(encoding="utf-8")
        debug_rules = (ROOT / "AIGC/workflows/game-development-lifecycle/rules/debug-observability.md").read_text(encoding="utf-8")
        verification_rules = (ROOT / "AIGC/workflows/game-development-lifecycle/rules/verification-and-retro.md").read_text(encoding="utf-8")
        template_index = (ROOT / "AIGC/workflows/game-development-lifecycle/templates/INDEX.md").read_text(encoding="utf-8")
        screen_contract = (ROOT / "AIGC/workflows/game-development-lifecycle/templates/screen-contract.md").read_text(encoding="utf-8")
        verification_template = (ROOT / "AIGC/workflows/game-development-lifecycle/templates/verification-retro.md").read_text(encoding="utf-8")
        asset_contract = (ROOT / "AIGC/workflows/game-development-lifecycle/templates/asset-pipeline-contract.md").read_text(encoding="utf-8")
        project_sync = (ROOT / "AIGC/workflows/game-development-lifecycle/templates/project-execution-sync-check.md").read_text(encoding="utf-8")
    ...
    def test_project_wiki_update_traceability_closure_is_routable(self) -> None:
        projects_index = (ROOT / "AIGC/projects/INDEX.md").read_text(encoding="utf-8")
        project_rules_index = (ROOT / "AIGC/projects/rules/INDEX.md").read_text(encoding="utf-8")
        update_rule = (ROOT / "AIGC/projects/rules/project-wiki-update.md").read_text(encoding="utf-8")
        capability_index = (ROOT / "AIGC/capabilities/INDEX.md").read_text(encoding="utf-8")
